...
: ${AMENT_CURRENT_PREFIX:="/root/main_controller/src/install/lakibeam1"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/lakibeam1/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/lakibeam1/environment/path.sh"
